			...
			<div class="col-sm-9 col-md-10 main"
				...
				<div class="table-responsive">
					<table class="table table-striped">
						...
						<tbody id="tbody01">
							<?php foreach ($advices as $advices_item): ?>
							<tr>
								<td><?php echo $advices_item['advicer']; ?></td>
								<td><?php echo $advices_item['content']; ?></td>
								<td><?php echo $advices_item['createtime']; ?></td>
							</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
