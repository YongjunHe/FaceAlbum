			...
			<div class="col-sm-9 col-md-10 main"
				...
				<div class="table-responsive">
					<table class="table table-striped">
						...
						<tbody id="tbody01">
							<?php foreach ($friends as $friends_item): ?>
							<tr>
								<td><?php echo $friends_item['userid']; ?></td>
								<td><?php echo $friends_item['username']; ?></td>
								<td>5</td>
					...
					<form class="form-inline" action="" method="post" role="form">
						<div class="form-group">
							<label class="sr-only" for="userid">userid</label> <input
								type="text" name="friendid" class="form-control" id="friendid"
