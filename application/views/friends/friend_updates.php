...
<body class="no-trans">
								...
								<div class="container-fluid">
									...
									<div class="collapse navbar-collapse scrollspy smooth-scroll"
										...
										<ul class="nav navbar-nav navbar-right ux">
											...
											<li class="active"><a
												href="<?php echo site_url('/Friend/overview'); ?>">关注</a></li>
	...
	<div class="container-fluid" id="banner"
		...
		<div class="row">
				...
				<div class="fixed-siderbar">
					...
					<ul class="nav nav-sidebar">
						<li id="btn1"><a id="word1"
							href="<?php echo site_url('/Friend/overview')?>">我的好友</a></li>
						<li id="btn2" style="background-color: #336699;"><a id="word2"
							style="color: white;"
							href="<?php echo site_url('/Friend/friend_updates')?>">好友动态</a></li>
			...
			<div class="col-sm-9 col-md-10 main"
				...
				<h1 class="page-header">Circle Topics</h1>
				...
				<div class="table-responsive">
					<table class="table table-striped">
						...
						<tbody id="tbody01">
							<?php foreach ($updates as $updates_item): ?>
							<tr>
								<td><?php echo $updates_item['newsid']; ?></td>
								<td><?php echo $updates_item['authorid']; ?></td>
								<td><?php echo $updates_item['content']; ?></td>
								<td><?php echo $updates_item['updatetime']; ?></td>
								<td><button type="button" class="btn btn-primary btn-xs">commemt</button></td>
							</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
					<form class="form-inline" action="" method="post" role="form">
						<div class="form-group">
							<label class="sr-only" for="update">update</label> <input
								type="text" name="update" class="form-control" id="update"
								placeholder="update">
						</div>
						<button type="submit" class="btn btn-success">发表动态</button>
					</form>
	...
	<script type="text/javascript" src="js/friend_updates.js"></script>
</body>
</html>